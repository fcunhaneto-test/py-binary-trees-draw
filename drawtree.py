...
class DrawTree:
    ...
    def make_points_lines(self, root, tree_height, nodes_dict):
        ...
        self.points_dict[root.key] = (root_x, root_y + self.RADIUS)
        if nodes_dict:
            lines = {}
            for node in nodes_dict:
                parent, height = node
                left, right = nodes_dict[node]
    ...
    def draw_nodes(self):
        if self.value:
            ...
            self.make_points_lines(self.bt.root, tree_height, nodes_dict)
